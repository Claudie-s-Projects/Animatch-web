    ...
    <div v-else class="space-y-4">
      ...
      >
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="text-sm text-gray-500">{{ demande.animal.refuge?.nom }} — {{ demande.animal.refuge?.ville }}</p>
          <p class="text-xs text-gray-400 mt-1">{{ new Date(demande.created_at).toLocaleDateString('fr-BE') }}</p>
        </div>
        <button
