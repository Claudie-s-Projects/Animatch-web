...
<template>
  <div class="flex flex-wrap gap-3 mb-8">
    ...
    <select v-model="filters.urgence" @change="emitChange" class="border rounded-lg px-3 py-2 text-sm bg-white">
    ...
    <div class="flex gap-2">
      ...
      />
      <button @click="emitChange" class="px-3 py-2 bg-blush-400 text-white text-sm rounded-lg hover:bg-blush-500">OK</button>
    </div>
